# ❤️ Flutter Heartbeat Animation  

A **beautiful and smooth heartbeat animation** built using **Flutter's CustomPainter and AnimationController**. This package provides a lightweight and customizable solution for adding a pulsating heartbeat effect to your Flutter applications. Whether you are building a health app, a romantic UI element, or a unique loading animation, this widget offers full flexibility to match your design needs.  

## ✨ Features  
✅ **Customizable Design** – Adjust size, color, and animation speed  
✅ **Smooth Animations** – Powered by Flutter’s **AnimationController**  
✅ **Lightweight & Efficient** – Optimized for performance  
✅ **Easy Integration** – Just plug and play with minimal setup  

---
## 📸 Preview  

### 🎥 With Heart Animation  
[![Watch the video](https://img.youtube.com/vi/VIDEO_ID/maxresdefault.jpg)](https://github.com/Arslan4546/Custom-HeartBeat-Animation-Flutter/blob/main/project_vid/with_heart.mp4)

### 🎥 Simple Heartbeat Animation  
[![Watch the video](https://img.youtube.com/vi/VIDEO_ID/maxresdefault.jpg)](https://github.com/Arslan4546/Custom-HeartBeat-Animation-Flutter/blob/main/project_vid/simple_heart_beat.mp4)
